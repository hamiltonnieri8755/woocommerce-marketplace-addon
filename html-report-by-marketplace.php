			...
			<div class="chart-sidebar">
				<ul class="chart-legend">
					...
					<li style="border-color: <?php echo $this->chart_colours[0]; ?>" class="highlight_series tips" data-series="0" data-tip="This is the sum of the WebStore order totals">
						<strong>
							<span class="amount"><?php echo $this->get_mp_total_formatted(0); ?></span>
						</strong>
						<span class="channel-name">WebStore</span>
						<span class="percent">&nbsp;(&nbsp;<?php echo $this->get_mp_percent(0); ?>&nbsp;)&nbsp;</span><br/>
						<?php 
							$ws_bestseller = $this->get_best_seller_mp(0); 
							if ( ! empty( $ws_bestseller ) ) {
								echo "<span class='bestseller'>" . $ws_bestseller['name'] . " ( " . $ws_bestseller['qty'] . " )" . "</span>";
							}
						?>
					</li>
					...
					<li style="border-color: <?php echo $this->chart_colours[1]; ?>" class="highlight_series tips" data-series="1" data-tip="This is the sum of the Amazon order totals">
						<strong>
							<span class="amount"><?php echo $this->get_mp_total_formatted(1); ?></span>
						</strong>
						<span class="marketplace">
						<span class="channel-name">Amazon</span>
						<span class="percent">&nbsp;(&nbsp;<?php echo $this->get_mp_percent(1); ?>&nbsp;)&nbsp;</span><br/>
						<?php 
							$amazon_bestseller = $this->get_best_seller_mp( 1 ); 
							if ( ! empty( $amazon_bestseller ) ) {
								echo "<span class='bestseller'>" . $amazon_bestseller['name'] . " ( " . $amazon_bestseller['qty'] . " )" . "</span>";
							}
						?>
					</li>
					...
					<li style="border-color: <?php echo $this->chart_colours[2]; ?>" class="highlight_series tips" data-series="2" data-tip="This is the sum of the eBay order totals">
						<strong>
							<span class="amount"><?php echo $this->get_mp_total_formatted(2); ?></span>
						</strong>
						<span class="channel-name">eBay</span>
						<span class="percent">&nbsp;(&nbsp;<?php echo $this->get_mp_percent(2); ?>&nbsp;)&nbsp;</span><br/>
						<?php 
							$ebay_bestseller = $this->get_best_seller_mp( 2 ); 
							if ( ! empty( $ebay_bestseller ) ) {
								echo "<span class='bestseller'>" . $ebay_bestseller['name'] . " ( " . $ebay_bestseller['qty'] . " )" . "</span>";
							}
						?>
					</li>

					<!-- Total Legend -->
					<li style="border-color: <?php echo $this->chart_colours[3]; ?>" class="highlight_overall tips" data-tip="This is the overall total">
						<strong>
						...
						<?php 
							$ebay_bestseller = $this->get_best_seller_mp( 3 ); 
							if ( ! empty( $ebay_bestseller ) ) {
								echo "<span class='bestseller'>" . $ebay_bestseller['name'] . " ( " . $ebay_bestseller['qty'] . " )" . "</span>";
							}
						?>
