		...
		<h3 class="stats_range">
			...
			<div class="category-input-wrapper">
				<select id="category_id">
					<?php
						$this->get_product_cats_list(); 
					?>
				</select>
				<input type="button" class="button" id="set_id" value="Show">
			</div>
			<ul>
				<li id="year" class="tab-link"><a href="?page=wc-reports&tab=orders_mp&report=sales_by_category&range=year&cat_id=<?php echo $this->category_id; ?>">Year</a></li>
				<li id="lastmonth" class="tab-link"><a href="?page=wc-reports&tab=orders_mp&report=sales_by_category&range=lastmonth&cat_id=<?php echo $this->category_id; ?>">Last Month</a></li>
				<li id="thismonth" class="tab-link"><a href="?page=wc-reports&tab=orders_mp&report=sales_by_category&range=thismonth&cat_id=<?php echo $this->category_id; ?>">This Month</a></li>
				<li id="last7day" class="tab-link"><a href="?page=wc-reports&tab=orders_mp&report=sales_by_category&range=last7day&cat_id=<?php echo $this->category_id; ?>">Last 7 Days</a></li>				
				<li id="custom" class="custom">
					Custom:					
					<form method="GET">
						<div>
							<input type="hidden" name="cat_id" id="category_id_custom" value="">
							...
							<input name="report" value="sales_by_category" type="hidden">							
				...
				<h2>
					<?php
						if ( ! empty($this->category_id) ) {
							echo get_cat_name( $this->category_id ) . " is selected.";
						} else {
...
<script type="text/javascript">
	jQuery(document).ready(function () {
		...
		// Save Category ID and Name to sessionStorage and refresh the page to show sales data
		jQuery("#set_id").click(function () {
			window.location.href = window.location.href + "&cat_id=" + jQuery("#category_id").val();
		});
